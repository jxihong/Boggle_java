...
public class JBoggleTimer extends JLabel {
  ...
  private class TimerHandler implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      ...
      if (elapsed < totalSeconds * 1000) {
        // The time is still going.  Generate a time-string for the elapsed
        // time.
  ...
  /**
   * Set the amount of time remaining on the timer.  The argument is in seconds;
   * for example, Boggle timers are typically 3 minutes, so this can be set to
   * 180 for 3 minutes.
   **/
